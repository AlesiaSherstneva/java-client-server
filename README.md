...
Класс Socketor содержит в себе экземпляр класса Phone, которому переданы операции по запуску сервера/клиента и 
чтению/записи данных. Поэтому нельзя запустить Socketor напрямую через файл Socketor.java, как это было с предыдущими 
заданиями.
